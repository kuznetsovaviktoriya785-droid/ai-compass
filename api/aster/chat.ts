...
const SYSTEM_PROMPT = [
  ...
  'Никогда не заканчивай ответ на незавершённом предложении. Если ответ нужно сократить, сократи количество мыслей, но обязательно закончи последнее предложение и последнюю мысль полностью.',
  'Для обычного ответа давай 2-4 законченных предложения. Не отвечай одним обрывочным тезисом, если вопрос требует объяснения.',
].join(' ')
